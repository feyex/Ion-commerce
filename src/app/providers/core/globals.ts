...
import { accountsInfoModel, appConfig } from '../../models/model';
...
export class GlobalsProvider 
{
  ...
  showLoader({ cssClass = '', content = null, dismissOnPageChange = true } = {}) {
  ...
  getUserData = async (): Promise<any> =>
  {
    return await new Promise((resolve, reject) => {
      this.storage.getItem("accountuser")
      .then((user: accountsInfoModel) => { 
